...
/**
 * The [ImageSpec] defines a request to run a specific image. It specifies:
 ...
 * @property arguments the list of arguments, that will be passed to
 *     script upon invoking
 * @property tag the tag of the image, "latest" by default
 */
data class ImageSpec(val name: String, val script: String, val arguments: List<String>, val tag: String) {
    ...
    companion object {
        fun from(imageName: String, script: String, arguments: List<String>, tag: String? = null): ImageSpec {
            return ImageSpec(imageName, script, arguments, tag ?: "latest")
        }
    }
