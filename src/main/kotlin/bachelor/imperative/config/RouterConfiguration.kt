...
class RouterConfiguration {
     ...
     *   the image
     * - arguments - an optional request body in JSON ARRAY format,
     *   specifies the arguments that will be passed to the script
    ...
    private fun getArguments(request: ServerRequest): Mono<List<String>> =
        request.bodyToMono()
}